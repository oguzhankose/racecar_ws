...
class DriverNode():
    ...
    def __init__(self, cmd_type="path"):
        ...
        #self.Pid = zPIDController(Kp = 2, Ki = 0.0, Kd = 0.2)
        self.Stanley = StanleyController(k_e = 0.001, k_s = 0.0, vel=self.speed)
    ...
    def pose_callback(self, msg):
        ...
        steering_angle = self.Stanley.output(goal=target_y)
